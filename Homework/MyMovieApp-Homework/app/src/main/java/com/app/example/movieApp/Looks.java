...
public class Looks extends AppCompatActivity implements MovieAdapter.OnItemClickListener, LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if(NetworkCheck.networkStatus(Looks.this)){
                new FetchMovies().execute();
            }else{
                AlertDialog.Builder dialog = new AlertDialog.Builder(Looks.this);
    ...
    public android.support.v4.content.Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(this,
               MovieContract.MovieEntry.CONTENT_URI,
                MovieContract.MovieEntry.MOVIE,
                null,
                null,
                null);
    }
    ...
    public class FetchMovies extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                if(NetworkCheck.networkStatus(Looks.this)){
                    mPopularList = NetworkCheck.fetchData(popularMoviesURL);
                    mTopTopRatedList = NetworkCheck.fetchData(topRatedMoviesURL);
        ...
        protected void onPostExecute(Void  s) {
            ...
            mAdapter = new MovieAdapter(new ArrayList<Movie>(), Looks.this);
            mAdapter.add(mPopularList);
            movie_grid_recyclerView.setAdapter(mAdapter);
        }
    }
